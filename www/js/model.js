...
function inicializarBanco(){
	...
	db.transaction(function(tx){
		tx.executeSql('create table if not exists Anotacoes(id integer not null primary key autoincrement, conteudo text not null, published data)',
...
function sueccessCallBackInserir(){
